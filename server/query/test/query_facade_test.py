...
if __name__ == "__main__":
    ...
    out = Hangman.execute(query)
    print(out)
    expected = {'1,2,3,4,1,2,3', '1,2,3,4,1,4,5', '1,2,3,4,1,6,7', '1,2,3,4,2,3,4', '1,2,3,4,2,5,6', '1,2,3,4,2,7,8',
                '1,2,3,4,3,4,5', '1,2,3,4,3,6,7', '1,2,3,4,3,8,9', '5,6,7,8,1,2,3', '5,6,7,8,1,4,5', '5,6,7,8,1,6,7',
                '5,6,7,8,2,3,4', '5,6,7,8,2,5,6', '5,6,7,8,2,7,8', '5,6,7,8,3,4,5', '5,6,7,8,3,6,7', '5,6,7,8,3,8,9',
                '9,10,11,12,1,2,3', '9,10,11,12,1,4,5', '9,10,11,12,1,6,7', '9,10,11,12,2,3,4', '9,10,11,12,2,5,6',
                '9,10,11,12,2,7,8', '9,10,11,12,3,4,5', '9,10,11,12,3,6,7', '9,10,11,12,3,8,9'}
